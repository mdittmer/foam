...
CLASS({
  ...
  extendsModel: 'foam.dao.index.Tokenizer',
  traits: [
  ],

  constants: {
    TOK_END: false, // Must be false-y!
    SAQ:
      // Some Answered Questions by ‘Abdu’l-Bahá courtesy of Project
      // Guttenberg. This is a good example of punctuation and accents
      // showing up somewhat frequently in a very large string.
      multiline(function() {/*
The Project Gutenberg EBook of Some Answered Questions by ‘Abdu’l-Bahá
...
Release Date: September 2006 [Ebook #19289]
...
***START OF THE PROJECT GUTENBERG EBOOK SOME ANSWERED QUESTIONS***
...
Part Three: ON THE POWERS AND CONDITIONS OF THE MANIFESTATIONS OF GOD
   ...
   45: EXPLANATION OF THE VERSE OF THE KITÁB-I-AQDAS, “THERE IS NO PARTNER
...
whom Ishmael was born, one of whose descendants was Muḥammad. In
consequence of His exile the Báb appeared from His posterity,(5) and the
...
was very difficult. According to the text of the Gospel the Pharisees
...
Now we come to Muḥammad. Americans and Europeans have heard a number of
...
others were ignorant Muslims who repeated unfounded traditions about
Muḥammad which they ignorantly believed to be to His praise.
...
field of battle a follower of Muḥammad had cut off the heads of one
hundred men! This misled the clergyman to infer that killing is considered
the way to prove one’s faith to Muḥammad, while this is merely imaginary.
The military expeditions of Muḥammad, on the contrary, were always
...
foreign lands. Muḥammad Himself, after the most extreme persecutions by
...
beat, curse and torture her until death released her. According to the
...
His followers. It was under such circumstances that Muḥammad was forced to
...
What objection, then, can be taken to Muḥammad’s action? Is it this, that
...
the greatest kindness, and to coerce and restrain them was a true mercy.
...
Muḥammad never fought against the Christians; on the contrary, He treated
them kindly and gave them perfect freedom. A community of Christian people
lived at Najrán and were under His care and protection. Muḥammad said, “If
...
Muḥammadan married a Christian woman, the husband must not prevent her
...
In case of war between Islám and her enemies, the Christians should be
exempted from the obligation of fighting, unless they desired of their own
free will to do so in defense of Islám, because they were under its
...
the Muḥammadans and the Christians, hatred and enmity arose between them.
...
For example, the Muslims say that Muḥammad cleft the moon, and that it
fell on the mountain of Mecca: they think that the moon is a small body
which Muḥammad divided into two parts and threw one part on this mountain,
and the other part on another mountain.

Such stories are pure fanaticism. Also the traditions which the clergy
quote, and the incidents with which they find fault, are all exaggerated,
if not entirely without foundation.

Briefly, Muḥammad appeared in the desert of Ḥijáz in the Arabian
...
desert, and are entirely destitute of education and science. Muḥammad
Himself was illiterate, and the Qur’án was originally written upon the
bladebones of sheep, or on palm leaves. These details indicate the
condition of the people to whom Muḥammad was sent. The first question
...
movement around an axis.(12) Again, in another verse, “And each star moves
in its own heaven.”(13) Thus is explained the movement of the sun, of the
moon, of the earth, and of other bodies. When the Qur’án appeared, all the
mathematicians ridiculed these statements and attributed the theory to
ignorance. Even the doctors of Islám, when they saw that these verses were
...
nine hundred years after Muḥammad, that a famous astronomer made new
...
the verses of the Qur’án agreed with existing facts, and that the
Ptolemaic system was imaginary.

In short, many Oriental peoples have been reared for thirteen centuries
under the shadow of the religion of Muḥammad. During the Middle Ages,
...
Man, Muḥammad. Was this illustrious Man a thorough Educator or not? A just
...
_Sh_í’is that He had never studied in any school and had not acquired
knowledge from any teacher; all the people of _Sh_íráz bear witness to
...
all the ‘ulamá of Persia.(16) All alone, in a way which is beyond
...
Many ‘ulamá and public men, as well as other people, joyfully sacrificed
...
the glad tidings of the manifestation of the Sun of Bahá to His followers
...
Bahá’u’lláh(17) appeared at a time when the Persian Empire was immersed in
...
It was at this time that Bahá’u’lláh appeared. His father was one of the
viziers, not one of the ‘ulamá. As all the people of Persia know, He had
never studied in any school, nor had He associated with the ‘ulamá or the
...
As soon as the Báb became manifested, Bahá’u’lláh said, “This great Man is
the Lord of the righteous, and faith in Him is incumbent upon all.” And He
arose to assist the Báb and gave many proofs and positive evidences of His
truth, in spite of the fact that the ‘ulamá of the state religion had
...
Regardless of this, Bahá’u’lláh arose to proclaim the word of the Báb with
...
much so that in Ṭihrán, Ba_gh_dád, Constantinople, Rumelia, and even in
Akká, every one of the learned and scientific men who entered His
...
It often happened that in Ba_gh_dád certain Muḥammadan ‘ulamá, Jewish
...
and convincing reply, and retired satisfied. Even the Persian ‘ulamá who
were at Karbilá and Najaf chose a wise man whom they sent on a mission to
Him; his name was Mullá Ḥasan ‘Amú. He came into the Holy Presence, and
proposed a number of questions on behalf of the ‘ulamá, to which
Bahá’u’lláh replied. Then Ḥasan ‘Amú said, “The ‘ulamá recognize without
hesitation and confess the knowledge and virtue of Bahá’u’lláh, and they
...
learning; but still the ‘ulamá say, ‘We are not contented with this; we do
...
“The ‘ulamás must, therefore, assemble, and, with one accord, choose one
...
imposture.” The learned man, Ḥasan ‘Amú, rose and replied, “There is no
more to be said”; he then kissed the knee of the Blessed One although he
was not a believer, and went. He gathered the ‘ulamá and gave them the
...
Karbilá he went to Kirman_sh_áh and Ṭihrán and spread a detailed account
...
always spoke of Him as “the renowned Bahá’u’lláh.”

At the time when this great Light suddenly arose upon the horizon of
Persia, all the people, the ministers, the ‘ulamá and men of other classes
...
Bahá’u’lláh alone and without support resisted them all, without ever
...
that Persia may return to a state of quietude.”
...
throughout Persia only, but the exile of Bahá’u’lláh caused the diffusion
of the Cause throughout other countries. Afterward His enemies said,
“‘Iráq-i-‘Arab(20) is not far enough from Persia; we must send him to a
more distant kingdom.” This is why the Persian government determined to
send Bahá’u’lláh from ‘Iráq to Constantinople. Again the event proved that
...
the prison of Akká, which is reserved especially for murderers, thieves
...
greatness of Bahá’u’lláh then became evident, for it was from this prison
...
arisen through the fault of the ‘ulamá.

When Bahá’u’lláh came to this prison in the Holy Land, the wise men
realized that the glad tidings which God gave through the tongue of the
Prophets two or three thousand years before were again manifested, and
that God was faithful to His promise; for to some of the Prophets He had
revealed and given the good news that “the Lord of Hosts should be
...
Persia, and to pitch His tent in this Holy Land, but for the persecution
of His enemies, His banishment and exile. His enemies intended that His
imprisonment should completely destroy and annihilate the blessed Cause,
but this prison was in reality of the greatest assistance and became the
means of its development. The divine renown of Bahá’u’lláh reached the
East and the West, and the rays of the Sun of Truth illuminated all the
world. Praise be to God! though He was a prisoner, His tent was raised on
Mount Carmel, and He moved abroad with the greatest majesty. Every person,
friend or stranger, who came into His presence used to say, “This is a
prince, not a captive.”

Upon His arrival in prison(21) He addressed an epistle to Napoleon,(22)
...
Napoleon made no reply. Then a second epistle was issued, which is
contained in the Súriy-i-Haykal.(23) The epitome of it is: “Oh Napoleon,
as thou hast not listened to My proclamation, and as thou hast not
answered it, thy dominion will before long be taken away from thee, and
thou wilt be utterly destroyed.” This epistle was sent to Napoleon by
post, through the care of Cesar Ketaphakou,(24) as was known to all the
companions of His exile. The text of this warning reached the whole of
Persia, for it was at that time that the Kitáb-i-Haykal was spread in
Persia, and this epistle was among the contents of this book. This
happened in A.D. 1869, and as this Súriy-i-Haykal was circulated in Persia
and India and was in the hands of all believers, they were waiting to see
what would come to pass. Not long after, in A.D. 1870, the war between
Germany and France broke out; and though no one at that time expected the
victory of Germany, Napoleon was defeated and dishonored; he surrendered
to his enemies, and his glory was changed into deep abasement.

Tablets(25) were also sent to other kings, and among them was the letter
to H. M. Náṣiri’d-Dín _Sh_áh. In that epistle Bahá’u’lláh said, “Have Me
summoned, gather the ‘ulamá, and ask for proofs and arguments, so that the
truth and falsehood may become known.” H. M. Náṣiri’d-Dín _Sh_áh sent the
blessed epistle to the ‘ulamá and proposed to them that they should
...
opposer of religion and the enemy of the _Sh_áh.” His majesty the _Sh_áh
...
government? Alas! how much we respected these ‘ulamá, who cannot even
...
attributed many wonderful things to Bahá’u’lláh. Some believed that He was
a saint,(26) and some even wrote treatises about Him. One of them, Siyyid
Dávúdí, a Sunnite savant of Ba_gh_dád, wrote a short treatise in which he
related certain supernatural acts of Bahá’u’lláh. Even now, in all parts
...
greatness of Bahá’u’lláh. Though they did not believe in Him, still they
acknowledged His grandeur, and as soon as they entered the sacred spot,
the presence of Bahá’u’lláh produced such an effect on most of them that
...
Bahá’u’lláh had never studied Arabic; He had not had a tutor or teacher,
nor had He entered a school. Nevertheless, the eloquence and elegance of
His blessed expositions in Arabic, as well as His Arabic writings, caused
astonishment and stupefaction to the most accomplished Arabic scholars,
and all recognized and declared that He was incomparable and unequaled.

If we carefully examine the text of the Torah, we see that the Divine
Manifestation never said to those who denied Him, “Whatever miracle you
desire, I am ready to perform, and I will submit to whatever test you
propose.” But in the Epistle to the _Sh_áh, Bahá’u’lláh said clearly,
“Gather the ‘ulamá, and summon Me, that the evidences and proofs may be
established.”(27)

For fifty years Bahá’u’lláh faced His enemies like a mountain: all wished
to annihilate Him and sought His destruction. A thousand times they
planned to crucify and destroy Him, and during these fifty years He was in
constant danger.

In this day Persia is in such a state of decadence and ruin that all
intelligent men, whether Persians or foreigners, who realize the true
state of affairs, recognize that its progress, its civilization and its
reconstruction depend upon the promulgation of the teachings and the
development of the principles of this great Personage.

Christ, in His blessed day, in reality only educated eleven men: the
greatest of them was Peter, who, nevertheless, when he was tested, thrice
denied Christ. In spite of this, the Cause of Christ subsequently
permeated the world. At the present day Bahá’u’lláh has educated thousands
of souls who, while under the menace of the sword, raised to the highest
heaven the cry of “Yá Bahá’u’l-Abhá”;(28) and in the fire of tests, their
faces became illuminated like gold. Then reflect what will take place in
the future.

Finally, we must be just and acknowledge what an Educator this Glorious
Being was, what marvelous signs were manifested by Him, and what power and
might have been realized in the world through Him.
...
Today, at table, let us speak for a little of proofs. If you had come to
this blessed place in the days of the manifestation of the evident
Light,(29) if you had attained to the court of His presence, and had
witnessed His luminous beauty, you would have understood that His
teachings and perfection were not in need of further evidence.

Only through the honor of entering His presence, many souls became
confirmed believers; they had no need of other proofs. Even those people
who rejected and hated Him bitterly, when they had met Him, would testify
to the grandeur of Bahá’u’lláh, saying, “This is a magnificent man, but
...
I do not wish to mention the miracles of Bahá’u’lláh, for it may perhaps
...
non-Bahá’ís. But these narratives are not decisive proofs and evidences to
...
Bahá’u’lláh, but we do not recount them, as they do not constitute proofs
...
All the peoples of the world are awaiting two Manifestations, Who must be
...
In the religion of Muḥammad there is the promise of the Mihdí and the
...
The first was issued by Cyrus in the year 536 B.C.; this is recorded in
...
Daniel, let us prove the manifestations of Bahá’u’lláh and of the Báb. Up
...
the manifestation of the Báb there are 1844 years. When you add 456 years
...
the Báb’s manifestation according to the actual text of the Book of
...
that is spoken of. Consider how clearly the manifestation of the Báb is
...
according to lunar years from the mission and the Hejira of Muḥammad; for
in the religion of Muḥammad the lunar year is in use, as also it is the
...
are twelve hundred and sixty days. The Báb, the precursor of Bahá’u’lláh,
appeared in the year 1260 from the Hejira of Muḥammad, by the reckoning of
Islám.
...
of the prophethood of Muḥammad in the country of Ḥijáz; and that was three
years after His mission, because in the beginning the prophethood of
Muḥammad was kept secret, and no one knew it save _Kh_adíjah and Ibn
Nawfal.(36) After three years it was announced. And Bahá’u’lláh, in the
year 1290 from the proclamation of the mission of Muḥammad, caused His
...
Qur’án. For in the texts of the Holy Book, each day is a year; as it is
said in the fourth chapter of Ezekiel, verse 6: “Thou shalt bear the
iniquity of the house of Judah forty days: I have appointed thee each day
for a year.”

This prophesies the duration of the Dispensation of Islám when Jerusalem
...
Báb, the “Gate” of Bahá’u’lláh, which took place in the year 1260 of the
Hejira of Muḥammad, and as the period of twelve hundred and sixty years
...
Noah, Abraham, Moses, Christ, Muḥammad, the Báb, and Bahá’u’lláh, and
...
virtues of humanity, have disappeared; and its form has remained in the
hands of the clergy and the priests. Likewise, the foundation of the
religion of Muḥammad has disappeared, but its form remains in the hands of
the official ‘ulamá.
...
These two witnesses are Muḥammad the Messenger of God, and ‘Alí, son of
Abú Tálib.

In the Qur’án it is said that God addressed Muḥammad, the Messenger of
...
days, each day signifying a year. Now, Muḥammad was the root, and ‘Alí the
...
Muḥammad’s spiritual Law corresponds to that of Christ in the Gospel, and
...
be like kings. The law and teachings of Muḥammad, and the explanations and
commentaries of ‘Alí, are a heavenly bounty; if they wish to give this
...
meaning that the prophethood of Muḥammad was the same as that of Moses,
and that the power of ‘Alí was the same as that of Joshua: if they wished,
...
people, which were the causes of the life of the nation, became, through
...
religion of Muḥammad and against the reality of ‘Alí—in other words, the
love of God.
...
crucified.”(48) “Their bodies” means the Religion of God, and “the street”
means in public view. The meaning of “Sodom and Egypt,” the place “where
also our Lord was crucified,” is this region of Syria, and especially
Jerusalem, where the Umayyads then had their dominions; and it was here
that the Religion of God and the divine teachings first disappeared, and a
body without spirit remained. “Their bodies” represents the Religion of
God, which remained like a dead body without spirit.

“And they of the people and kindreds and tongues and nations shall see
their dead bodies three days and a half, and shall not suffer their dead
bodies to be put in graves.”(49)
...
are forty and two months, and forty and two months twelve hundred and
sixty days; and as each day by the text of the Holy Book signifies one
year, the meaning is that for twelve hundred and sixty years, which is the
cycle of the Qur’án, the nations, tribes and peoples would look at their
bodies—that is to say, that they would make a spectacle of the Religion of
God: though they would not act in accordance with it, still, they would
not suffer their bodies—meaning the Religion of God—to be put in the
grave. That is to say, that in appearance they would cling to the Religion
of God and not allow it to completely disappear from their midst, nor the
body of it to be entirely destroyed and annihilated. Nay, in reality they
would leave it, while outwardly preserving its name and remembrance.

Those “kindreds, people and nations” signify those who are gathered under
the shadow of the Qur’án, not permitting the Cause and Law of God to be,
in outward appearance, entirely destroyed and annihilated—for there are
prayer and fasting among them—but the fundamental principles of the
Religion of God, which are morals and conduct, with the knowledge of
divine mysteries, have disappeared; the light of the virtues of the world
of humanity, which is the result of the love and knowledge of God, is
extinguished; and the darkness of tyranny, oppression, satanic passions
and desires has become victorious. The body of the Law of God, like a
corpse, has been exposed to public view for twelve hundred and sixty days,
each day being counted as a year, and this period is the cycle of
Muḥammad.

The people forfeited all that these two persons had established, which was
the foundation of the Law of God, and destroyed the virtues of the world
of humanity, which are the divine gifts and the spirit of this religion,
to such a degree that truthfulness, justice, love, union, purity,
...
cycle of the Furqán.(50) It was as if these two persons were dead, and
their bodies were remaining without spirit.
...
tormented them that dwelt on the earth.”(51) “Those who dwelt upon the
...
entirely changed, the Law of God forsaken—that virtues, zeal and honor had
departed from among them, and that their qualities were changed—became
happy, and rejoiced that corruption of morals had infected the people of
Islám, and that they would in consequence be overcome by other nations. So
this thing has come to pass. Witness this people which had attained the
summit of power, how degraded and downtrodden it is now.

The other nations “shall send gifts to one another,” meaning that they
should help each other, for “these two prophets tormented them that dwelt
upon the earth”—that is, they overcame the other nations and peoples of
the world and conquered them.
...
saw them.”(52) Three days and a half, as we before explained, is twelve
hundred and sixty years. Those two persons whose bodies were lying
spiritless are the teachings and the law that Muḥammad established and
‘Alí promoted, from which, however, the reality had departed and only the
...
spirituality of the Religion of God had been changed into materiality, and
virtues into vices; the love of God had been changed into hatred,
enlightenment into darkness, divine qualities into satanic ones, justice
into tyranny, mercy into enmity, sincerity into hypocrisy, guidance into
error, and purity into sensuality. Then after three days and a half, which
...
bounties were again renewed by the appearance of the Báb and the devotion
of Jináb-i-Quddús.(53)
...
This earthquake occurred in _Sh_íráz after the martyrdom of the Báb. The
...
When the earthquake took place in Fárs, all the remnant lamented and cried
...
The first woe is the appearance of the Prophet, Muḥammad, the son of
‘Abdu’lláh—peace be upon Him! The second woe is that of the Báb—to Him be
glory and praise! The third woe is the great day of the manifestation of
the Lord of Hosts and the radiance of the Beauty of the Promised One. The
explanation of this subject, woe, is mentioned in the thirtieth chapter of
Ezekiel, where it is said: “The word of the Lord came again unto me,
saying, Son of man, prophesy and say, Thus saith the Lord God; Howl ye,
Woe worth the day! For the day is near, even the day of the Lord is
near.”(60)

Therefore, it is certain that the day of woe is the day of the Lord; for
in that day woe is for the neglectful, woe is for the sinners, woe is for
the ignorant. That is why it is said, “The second woe is past; behold the
third woe cometh quickly!” This third woe is the day of the manifestation
of Bahá’u’lláh, the day of God; and it is near to the day of the
appearance of the Báb.

“And the seventh angel sounded; and there were great voices in heaven,
saying, The kingdoms of this world are become the kingdoms of our Lord,
and of His Christ; and He shall reign for ever and ever.”(61)
...
diffused. In the day of the manifestation of the Lord of Hosts, and at the
epoch of the divine cycle of the Omnipotent which is promised and
mentioned in all the books and writings of the Prophets—in that day of
God, the Spiritual and Divine Kingdom will be established, and the world
will be renewed; a new spirit will be breathed into the body of creation;
the season of the divine spring will come; the clouds of mercy will rain;
the sun of reality will shine; the life-giving breeze will blow; the world
of humanity will wear a new garment; the surface of the earth will be a
sublime paradise; mankind will be educated; wars, disputes, quarrels and
malignity will disappear; and truthfulness, righteousness, peace and the
worship of God will appear; union, love and brotherhood will surround the
world; and God will rule for evermore—meaning that the Spiritual and
Everlasting Kingdom will be established. Such is the day of God. For all
the days which have come and gone were the days of Abraham, Moses and
Christ, or of the other Prophets; but this day is the day of God, for the
Sun of Reality will arise in it with the utmost warmth and splendor.
...
and in the time of Muḥammad there were twelve Imáms. But in this glorious
...
“And the nations were angry,” for Thy teachings opposed the passions of
...
world of existence, and the darkness of ignorance and want of knowledge
...
But these verses apply word for word to Bahá’u’lláh. Likewise in this
...
replaced by peace, truth and concord; among the nations, peoples, races
...
Now consider, in this great century which is the cycle of Bahá’u’lláh,
...
Reflect also that in the short time since Bahá’u’lláh has appeared, people
...
a thousand years; for they are like father and child, mother and daughter,
...
cycle; but in the beginning of the cycle of Bahá’u’lláh this divine
...
of God that descended upon Muḥammad. The sun with which she was clothed,
...
of twelve stars.” These twelve stars are the twelve Imáms, who were the
promoters of the Law of Muḥammad and the educators of the people, shining
...
mother. The child Who is referred to is the Báb, the Primal Point, Who was
in truth born from the Law of Muḥammad—that is to say, the Holy Reality,
...
dynasty of the Umayyads who dominated the Muḥammadan religion. Seven heads
...
first is Abú Súfyán and the last Marván—but several of them bear the same
name. So there are two Muáviyá, three Yazíd, two Valíd, and two Marván;
but if the names were counted without repetition there would be ten. The
Umayyads, of whom the first was Abú Súfyán, Amír of Mecca and chief of the
dynasty of the Umayyads, and the last was Marván, destroyed the third part
of the holy and saintly people of the lineage of Muḥammad who were like
the stars of heaven.

Verse 4. “And the dragon stood before the woman which was ready to be
...
Manifestation, the offspring of the Law of Muḥammad. The Umayyads were
always waiting to get possession of the Promised One, Who was to come from
the line of Muḥammad, to destroy and annihilate Him; for they much feared
the appearance of the promised Manifestation, and they sought to kill any
of Muḥammad’s descendants who might be highly esteemed.
...
earth. This son is the Báb.

Verse 5. “And her child was caught up unto God, and to His throne.” This
is a prophecy of the Báb, Who ascended to the heavenly realm, to the
...
of God fled to the wilderness, meaning the vast desert of Ḥijáz, and the
Arabian Peninsula.
...
another. The Báb appeared in the year 1260 of the Hejira of Muḥammad,
which is the beginning of the universal era-reckoning of all Islám. There
...
Note.—In these last conversations ‘Abdu’l-Bahá wishes to reconcile in a
...
becomes another world, and it attains to a life-giving spirit. The earth
...
is exalted, the Law of God is promulgated; all things reach perfection.
The heavenly table is spread, the holy breezes perfume the East and the
West, the teachings of God conquer the world, men become educated,
praiseworthy results are produced, universal progress appears in the world
of humanity, and the divine bounties surround all things. The Sun of
Reality rises from the horizon of the Kingdom with the greatest power and
heat. When it reaches the meridian, it will begin to decline and descend,
and the spiritual summer will be followed by autumn, when growth and
development are arrested. Breezes change into blighting winds, and the
unwholesome season dissipates the beauty and freshness of the gardens,
plains and bowers—that is to say, attraction and goodwill do not remain,
divine qualities are changed, the radiance of hearts is dimmed, the
spirituality of souls is altered, virtues are replaced by vices, and
holiness and purity disappear. Only the name of the Religion of God
remains, and the exoteric forms of the divine teachings. The foundations
of the Religion of God are destroyed and annihilated, and nothing but
forms and customs exist. Divisions appear, firmness is changed into
instability, and spirits become dead; hearts languish, souls become inert,
and winter arrives—that is to say, the coldness of ignorance envelops the
world, and the darkness of human error prevails. After this come
indifference, disobedience, inconsiderateness, indolence, baseness, animal
instincts and the coldness and insensibility of stones. It is like the
season of winter when the terrestrial globe, deprived of the effect of the
heat of the sun, becomes desolate and dreary. When the world of
intelligence and thought has reached to this state, there remain only
continual death and perpetual nonexistence.

When the season of winter has had its effect, again the spiritual
springtime returns, and a new cycle appears. Spiritual breezes blow, the
luminous dawn gleams, the divine clouds give rain, the rays of the Sun of
Reality shine forth, the contingent world attains unto a new life and is
clad in a wonderful garment. All the signs and the gifts of the past
springtime reappear, with perhaps even greater splendor in this new
season.

The spiritual cycles of the Sun of Reality are like the cycles of the
material sun: they are always revolving and being renewed. The Sun of
Reality, like the material sun, has numerous rising and dawning places:
one day it rises from the zodiacal sign of Cancer, another day from the
...
to be always the place of sunset. In the same way, one must look for the
...
has been consumed in his body. This is the great honor and prosperity for
...
A subject that is essential(77) for the comprehension of the questions
that we have mentioned, and of others of which we are about to speak, so
...
else, he walks upon the earth. This exaltation and this progress are
...
We come to the explanation of the words of Bahá’u’lláh when He says: “O
...
was asleep, and the spring came, and it awoke; or the earth was dead, and
...
In the Qur’án it is said: “And We sent Our Spirit unto her, and He
...
things is even shown forth in the Qur’án: “Glory be to Him Who has created
...
phenomenal; in the beginning it was a flaming globe, and gradually it
...
greatness of Christ is His being fatherless, then Adam is greater than
...
As Christ desired that this institution of John should be used at that
...
But in the cycle of Bahá’u’lláh there is no longer need of this symbol;
...
according to the different necessities of the diseases and constitutions.
...
the heaven of God was the spirit of Christ. As the Jews thought that
...
bread did not signify this material bread, but rather the divine
...
lie? For both are generally admitted traditions, which are collected in
books, and may be supposed to be true or false.” The same may be said of
...
from the center of the Sun of Reality, from the Divine World, and the
Spiritual Kingdom. And as it has become evident that Christ came from the
spiritual heaven of the Divine Kingdom, therefore, His disappearance under
the earth for three days has an inner signification and is not an outward
fact. In the same way, His resurrection from the interior of the earth is
also symbolical; it is a spiritual and divine fact, and not material; and
likewise His ascension to heaven is a spiritual and not material
ascension.

Beside these explanations, it has been established and proved by science
that the visible heaven is a limitless area, void and empty, where
innumerable stars and planets revolve.

Therefore, we say that the meaning of Christ’s resurrection is as follows:
the disciples were troubled and agitated after the martyrdom of Christ.
The Reality of Christ, which signifies His teachings, His bounties, His
perfections and His spiritual power, was hidden and concealed for two or
three days after His martyrdom, and was not resplendent and manifest. No,
rather it was lost, for the believers were few in number and were troubled
...
life; His teachings and His admonitions became evident and visible. In
other words, the Cause of Christ was like a lifeless body until the life
and the bounty of the Holy Spirit surrounded it.
...
Gospels nor comprehended the symbols, therefore, it has been said that
religion is in contradiction to science, and science in opposition to
religion, as, for example, this subject of the ascension of Christ with an
elemental body to the visible heaven is contrary to the science of
mathematics. But when the truth of this subject becomes clear, and the
symbol is explained, science in no way contradicts it; but, on the
contrary, science and the intelligence affirm it.
...
Question.—What is the manner, and what is the meaning, of the descent of
the Holy Spirit upon the Apostles, as described in the Gospel?

Answer.—The descent of the Holy Spirit is not like the entrance of air
...
For example, knowledge, which is a state attained to by the intelligence,
...
Bahá’u’lláh has explained these verses in the Kitáb-i-Íqán.(91) There is
...
Christ Himself says: “And no man hath ascended up to heaven, but He that
...
and, God forbid! called the Messiah masí_kh_,(94) considered Him to be the
...
thief.”(95) Perhaps the thief will be in the house, and the owner will not
know it.

It is clear and evident that these signs have symbolic signification, and
that they are not literal. They are fully explained in the Kitáb-i-Íqán.
Refer to it.
...
Answer.—The Divine Reality, which is purified and sanctified from the
...
exaltation of holiness and sanctity. All that is mentioned of the
Manifestations and Dawning-places of God signifies the divine reflection,
and not a descent into the conditions of existence.(96)

God is pure perfection, and creatures are but imperfections. For God to
descend into the conditions of existence would be the greatest of
...
mirror. All the creatures are evident signs of God, like the earthly
beings upon all of which the rays of the sun shine. But upon the plains,
the mountains, the trees and fruits, only a portion of the light shines,
through which they become visible, and are reared, and attain to the
object of their existence, while the Perfect Man(97) is in the condition
of a clear mirror in which the Sun of Reality becomes visible and manifest
with all its qualities and perfections. So the Reality of Christ was a
clear and polished mirror of the greatest purity and fineness. The Sun of
Reality, the Essence of Divinity, reflected itself in this mirror and
manifested its light and heat in it; but from the exaltation of its
holiness, and the heaven of its sanctity, the Sun did not descend to dwell
and abide in the mirror. No, it continues to subsist in its exaltation and
sublimity, while appearing and becoming manifest in the mirror in beauty
and perfection.
...
is the spirituality of Christ. The physical nature is born of Adam, but
...
All sin comes from the demands of nature, and these demands, which arise
...
teach and educate men, and so He sacrificed Himself to give the spirit of
life. He perished in body so as to quicken others by the spirit.

The second meaning of sacrifice is this: Christ was like a seed, and this
seed sacrificed its own form so that the tree might grow and develop.
Although the form of the seed was destroyed, its reality became apparent
in perfect majesty and beauty in the form of a tree.

The position of Christ was that of absolute perfection; He made His divine
perfections shine like the sun upon all believing souls, and the bounties
of the light shone and radiated in the reality of men. This is why He
says: “I am the bread which descended from heaven; whosoever shall eat of
this bread will not die”(101)—that is to say, that whosoever shall partake
of this divine food will attain unto eternal life: that is, every one who
partakes of this bounty and receives these perfections will find eternal
life, will obtain preexistent favors, will be freed from the darkness of
error, and will be illuminated by the light of His guidance.

The form of the seed was sacrificed for the tree, but its perfections,
because of this sacrifice, became evident and apparent—the tree, the
branches, the leaves and the blossoms being concealed in the seed. When
the form of the seed was sacrificed, its perfections appeared in the
perfect form of leaves, blossoms and fruits.
...
Answer.—In the Bible it is written that God put Adam in the garden of
Eden, to cultivate and take care of it, and said to Him: “Eat of every
tree of the garden except the tree of good and evil, for if You eat of
that, You will die.”(102) Then it is said that God caused Adam to sleep,
and He took one of His ribs and created woman in order that she might be
His companion. After that it is said the serpent induced the woman to eat
of the tree, saying: “God has forbidden you to eat of the tree in order
that your eyes may not be opened, and that you may not know good from
evil.”(103) Then Eve ate from the tree and gave unto Adam, Who also ate;
their eyes were opened, they found themselves naked, and they hid their
bodies with leaves. In consequence of this act they received the
reproaches of God. God said to Adam: “Hast Thou eaten of the forbidden
tree?” Adam answered: “Eve tempted Me, and I did eat.” God then reproved
Eve; Eve said: “The serpent tempted me, and I did eat.” For this the
serpent was cursed, and enmity was put between the serpent and Eve, and
between their descendants. And God said: “The man is become like unto Us,
knowing good and evil, and perhaps He will eat of the tree of life and
live forever.” So God guarded the tree of life.(104)
...
details, such speeches and reproaches are far from being those of an
intelligent man, how much less of the Divinity—that Divinity Who has
organized this infinite universe in the most perfect form, and its
innumerable inhabitants with absolute system, strength and perfection.
...
arrangement, this invention, could have emanated from an intelligent
being. Therefore, this story of Adam and Eve who ate from the tree, and
their expulsion from Paradise, must be thought of simply as a symbol. It
contains divine mysteries and universal meanings, and it is capable of
marvelous explanations. Only those who are initiated into mysteries, and
those who are near the Court of the All-Powerful, are aware of these
secrets. Hence these verses of the Bible have numerous meanings.

We will explain one of them, and we will say: Adam signifies the heavenly
spirit of Adam, and Eve His human soul. For in some passages in the Holy
Books where women are mentioned, they represent the soul of man. The tree
of good and evil signifies the human world; for the spiritual and divine
world is purely good and absolutely luminous, but in the human world light
and darkness, good and evil, exist as opposite conditions.

The meaning of the serpent is attachment to the human world. This
attachment of the spirit to the human world led the soul and spirit of
Adam from the world of freedom to the world of bondage and caused Him to
turn from the Kingdom of Unity to the human world. When the soul and
spirit of Adam entered the human world, He came out from the paradise of
freedom and fell into the world of bondage. From the height of purity and
absolute goodness, He entered into the world of good and evil.

The tree of life is the highest degree of the world of existence: the
position of the Word of God, and the supreme Manifestation. Therefore,
...
the detachment of spirits from the human world, and their attraction to
...
were not the enemies of the light, and when once they understood that the
...
chosen,”(110) and in the Qur’án it is written: “He will confer particular
...
God that some creatures are chosen for the highest degree, as man, and
...
Answer.—Bahá’u’lláh has explained this question fully and clearly in the
Íqán.(113) Read it, and the truth of this subject will become apparent.
...
him, “Art thou Elijah?” He said, “I am not.”(114) These words prove and
show that John, the son of Zacharias, was not the promised Elias. But on
...
the end is a seed, we say that the seed has returned. When we look at the
...
wilderness, and was unwilling to hurt the feelings of anyone. The Pope
...
destroyer of the foundations of religion. While the religion of God is the
promoter of truth, the founder of science and knowledge, it is full of
goodwill for learned men; it is the civilizer of mankind, the discoverer
of the secrets of nature, and the enlightener of the horizons of the
world. Consequently, how can it be said to oppose knowledge? God forbid!
Nay, for God, knowledge is the most glorious gift of man and the most
noble of human perfections. To oppose knowledge is ignorant, and he who
detests knowledge and science is not a man, but rather an animal without
intelligence. For knowledge is light, life, felicity, perfection, beauty
and the means of approaching the Threshold of Unity. It is the honor and
glory of the world of humanity, and the greatest bounty of God. Knowledge
is identical with guidance, and ignorance is real error.

Happy are those who spend their days in gaining knowledge, in discovering
the secrets of nature, and in penetrating the subtleties of pure truth!
Woe to those who are contented with ignorance, whose hearts are gladdened
by thoughtless imitation, who have fallen into the lowest depths of
...
someone, and it has been written on the Tablet of Fate, is it possible to
resist it?

Answer.—The foreknowledge of a thing is not the cause of its realization;
for the essential knowledge of God surrounds, in the same way, the
realities of things, before as well as after their existence, and it does
not become the cause of their existence. It is a perfection of God. But
that which was prophesied by the inspiration of God through the tongues of
the Prophets, concerning the appearance of the Promised One of the Bible,
was not the cause of the manifestation of Christ.

The hidden secrets of the future were revealed to the Prophets, and They
thus became acquainted with the future events which They announced. This
knowledge and these prophecies were not the cause of the occurrences. For
example, tonight everyone knows that after seven hours the sun will rise,
but this general foreknowledge does not cause the rising and appearance of
the sun.
...
through the animal spirit. This perfected body can be compared to a
mirror, and the human spirit to the sun. Nevertheless, if the mirror
breaks, the bounty of the sun continues; and if the mirror is destroyed or
ceases to exist, no harm will happen to the bounty of the sun, which is
everlasting. This spirit has the power of discovery; it encompasses all
things. All these wonderful signs, these scientific discoveries, great
enterprises and important historical events which you know are due to it.
From the realm of the invisible and hidden, through spiritual power, it
brought them to the plane of the visible. So man is upon the earth, yet he
makes discoveries in the heavens. From known realities—that is to say,
from the things which are known and visible—he discovers unknown things.
For example, man is in this hemisphere; but, like Columbus, through the
power of his reason he discovers another hemisphere—that is, America—which
was until then unknown. His body is heavy, but through the help of
vehicles which he invents, he is able to fly. He is slow of movement, but
by vehicles which he invents he travels to the East and West with extreme
rapidity. Briefly, this power embraces all things.

But the spirit of man has two aspects: one divine, one satanic—that is to
say, it is capable of the utmost perfection, or it is capable of the
utmost imperfection. If it acquires virtues, it is the most noble of the
existing beings; and if it acquires vices, it becomes the most degraded
existence.
...
and by the divine power it becomes the cause of eternal life. It is the
power which makes the earthly man heavenly, and the imperfect man perfect.
It makes the impure to be pure, the silent eloquent; it purifies and
sanctifies those made captive by carnal desires; it makes the ignorant
wise.

The fifth spirit is the Holy Spirit. This Holy Spirit is the mediator
between God and His creatures. It is like a mirror facing the sun. As the
pure mirror receives light from the sun and transmits this bounty to
others, so the Holy Spirit is the mediator of the Holy Light from the Sun
of Reality, which it gives to the sanctified realities. It is adorned with
all the divine perfections. Every time it appears, the world is renewed,
and a new cycle is founded. The body of the world of humanity puts on a
new garment. It can be compared to the spring; whenever it comes, the
world passes from one condition to another. Through the advent of the
season of spring the black earth and the fields and wildernesses will
become verdant and blooming, and all sorts of flowers and sweet-scented
herbs will grow; the trees will have new life, and new fruits will appear,
and a new cycle is founded. The appearance of the Holy Spirit is like
this. Whenever it appears, it renews the world of humanity and gives a new
spirit to the human realities: it arrays the world of existence in a
praiseworthy garment, dispels the darkness of ignorance, and causes the
radiation of the light of perfections. Christ with this power has renewed
this cycle; the heavenly spring with the utmost freshness and sweetness
spread its tent in the world of humanity, and the life-giving breeze
perfumed the nostrils of the enlightened ones.

In the same way, the appearance of Bahá’u’lláh was like a new springtime
which appeared with holy breezes, with the hosts of everlasting life, and
with heavenly power. It established the Throne of the Divine Kingdom in
the center of the world and, by the power of the Holy Spirit, revived
...
Question.—What connection has the Reality of Divinity with the Lordly
Rising-places and the Divine Dawning-points?

Answer.—Know that the Reality of Divinity or the substance of the Essence
of Oneness is pure sanctity and absolute holiness—that is to say, it is
sanctified and exempt from all praise. The whole of the supreme attributes
of the degrees of existence, in reference to this plane, are only
imaginations. It is invisible, incomprehensible, inaccessible, a pure
essence which cannot be described, for the Divine Essence surrounds all
things. Verily, that which surrounds is greater than the surrounded, and
the surrounded cannot contain that by which it is surrounded, nor
comprehend its reality. However far mind may progress, though it may reach
to the final degree of comprehension, the limit of understanding, it
beholds the divine signs and attributes in the world of creation and not
in the world of God. For the essence and the attributes of the Lord of
Unity are in the heights of sanctity, and for the minds and understandings
there is no way to approach that position. “The way is closed, and seeking
is forbidden.”

It is evident that the human understanding is a quality of the existence
...
Unlimited Reality is limited to this place of appearance. God forbid! This
is the belief of the adherents of anthropomorphism. No; all the praises,
the descriptions and exaltations refer to the Holy Manifestations—that is
to say, all the descriptions, the qualities, the names and the attributes
which we mention return to the Divine Manifestations; but as no one has
attained to the reality of the Essence of Divinity, so no one is able to
describe, explain, praise or glorify it. Therefore, all that the human
reality knows, discovers and understands of the names, the attributes and
the perfections of God refer to these Holy Manifestations. There is no
access to anything else: “the way is closed, and seeking is forbidden.”

Nevertheless, we speak of the names and attributes of the Divine Reality,
and we praise Him by attributing to Him sight, hearing, power, life and
knowledge. We affirm these names and attributes, not to prove the
perfections of God, but to deny that He is capable of imperfections. When
we look at the existing world, we see that ignorance is imperfection and
knowledge is perfection; therefore, we say that the sanctified Essence of
God is wisdom. Weakness is imperfection, and power is perfection;
consequently, we say that the sanctified Essence of God is the acme of
power. It is not that we can comprehend His knowledge, His sight, His
power and life, for it is beyond our comprehension; for the essential
names and attributes of God are identical with His Essence, and His
Essence is above all comprehension. If the attributes are not identical
with the Essence, there must also be a multiplicity of preexistences, and
differences between the attributes and the Essence must also exist; and as
Preexistence is necessary, therefore, the sequence of preexistences would
become infinite. This is an evident error.

Accordingly all these attributes, names, praises and eulogies apply to the
Places of Manifestation; and all that we imagine and suppose beside them
...
distinguished through the illusion of your imagination in your subtle
mental images is but a creation like unto yourself, and returns to
you.”(121) It is clear that if we wish to imagine the Reality of Divinity,
this imagination is the surrounded, and we are the surrounding one; and it
is sure that the one who surrounds is greater than the surrounded. From
this it is certain and evident that if we imagine a Divine Reality outside
...
in the utmost perfection; but what a difference between the condition of
...
Christ, the splendors and brilliance of Bahá’u’lláh, and the virtues of
...
beginning nor end, for these things are related to the world of
...
sleeping or waking is the same man; sleep is one state, and wakefulness is
another. The time of silence is compared to sleep, and manifestation and
guidance are compared to wakefulness.

In the Gospel it is said, “In the beginning was the Word, and the Word was
with God.”(125) Then it is evident and clear that Christ did not reach to
the station of Messiahship and its perfections at the time of baptism,
when the Holy Spirit descended upon Him in the likeness of a dove. Nay,
the Word of God from all eternity has always been, and will be, in the
...
We said that the Manifestations have three planes. First, the physical
reality, which depends upon the body; second, the individual reality, that
is to say, the rational soul; third, the divine appearance, which is the
divine perfections, the cause of the life of existence, of the education
of souls, of the guidance of people, and of the enlightenment of the
contingent world.

The physical state is the human state which perishes because it is
composed of elements, and all that is composed of elements will
necessarily be decomposed and dispersed.

But the individual reality of the Manifestations of God is a holy reality,
and for that reason it is sanctified and, in that which concerns its
nature and quality, is distinguished from all other things. It is like the
sun, which by its essential nature produces light and cannot be compared
to the moon, just as the particles that compose the globe of the sun
cannot be compared with those which compose the moon. The particles and
organization of the former produce rays, but the particles of which the
moon is composed do not produce rays but need to borrow light. So other
human realities are those souls who, like the moon, take light from the
sun; but that Holy Reality is luminous in Himself.

The third plane of that Being(126) is the Divine Bounty, the splendor of
the Preexistent Beauty, and the radiance of the light of the Almighty. The
...
elemental form. For example, if a lamp illumines this niche, and if its
light ceases to illuminate it because the niche is destroyed, the bounty
of the lamp is not cut off. Briefly, in the Holy Manifestations the
...
words which Bahá’u’lláh said, “I was asleep, and the breeze passed over
...
Question.—One of the powers possessed by the Divine Manifestations is
...
proceeds from the realities of things, and He will certainly not be able
...
Afterward, other Manifestations will arise under His shadow, Who according
...
We are in the cycle which began with Adam, and its supreme Manifestation
is Bahá’u’lláh.
...
Question.—What is the degree of the power and the perfections of the
Thrones of Reality, the Manifestations of God, and what is the limit of
Their influence?

Answer.—Consider the world of existence—that is to say, the world of
material things. The solar system is dark and obscure, and in it the sun
is the center of light, and all the planets of the system revolve around
its might and are partakers of its bounty. The sun is the cause of life
and illumination, and the means of the growth and development of all the
beings of the solar system; for without the bounty of the sun no living
being could exist: all would be dark and destroyed. Therefore, it is
evident and clear that the sun is the center of light and the cause of the
life of the beings of the solar system.

In like manner, the Holy Manifestations of God are the centers of the
light of reality, of the source of mysteries, and of the bounties of love.
They are resplendent in the world of hearts and thoughts, and shower
eternal graces upon the world of spirits; They give spiritual life and are
shining with the light of realities and meanings. The enlightenment of the
world of thought comes from these centers of light and sources of
mysteries. Without the bounty of the splendor and the instructions of
these Holy Beings the world of souls and thoughts would be opaque
darkness. Without the irrefutable teachings of those sources of mysteries
the human world would become the pasture of animal appetites and
qualities, the existence of everything would be unreal, and there would be
no true life. That is why it is said in the Gospel: “In the beginning was
the Word,” meaning that it became the cause of all life.(131)

Now consider the influence of the sun upon the earthly beings, what signs
and results become evident and clear from its nearness and remoteness,
from its rising or its setting. At one time it is autumn, at another time
spring; or again it is summer or winter. When the sun passes the line of
the equator, the life-giving spring will become manifest in splendor, and
when it is in the summer solstice, the fruits will attain to the acme of
perfection, grains and plants will yield their produce, and earthly beings
will attain their most complete development and growth.

In like manner, when the Holy Manifestation of God, Who is the sun of the
world of His creation, shines upon the worlds of spirits, of thoughts and
of hearts, then the spiritual spring and new life appear, the power of the
wonderful springtime becomes visible, and marvelous benefits are apparent.
As you have observed, at the time of the appearance of each Manifestation
of God extraordinary progress has occurred in the world of minds, thoughts
and spirits. For example, in this divine age see what development has been
...
divine teachings will illuminate this dark world and will transform these
sad regions into the paradise of Eden.

If we were to explain the signs and bounties of each of the Holy
Manifestations, it would take too long. Think and reflect upon it
yourself, and then you will attain to the truth of this subject.
...
independent Prophets Who are followed; the other kind are not independent
and are themselves followers.
...
are, for example, Abraham, Moses, Christ, Muḥammad, the Báb and
Bahá’u’lláh. But the others who are followers and promoters are like
Solomon, David, Isaiah, Jeremiah and Ezekiel. For the independent Prophets
are founders; They establish a new religion and make new creatures of men;
They change the general morals, promote new customs and rules, renew the
cycle and the Law. Their appearance is like the season of spring, which
arrays all earthly beings in a new garment, and gives them a new life.
...
not continued in accordance with their fundamental teachings. The founder
of Buddhism was a wonderful soul. He established the Oneness of God, but
later the original principles of His doctrines gradually disappeared, and
ignorant customs and ceremonials arose and increased until they finally
ended in the worship of statues and images.

Now, consider: Christ frequently repeated that the Ten Commandments in the
Pentateuch were to be followed, and He insisted that they should be
...
addressed to the Prophets, in reality are directed to the people, through
...
of God? Indeed, no. You have seen with your own eyes that day and night
...
In the same way in the Qur’án it is said to Muḥammad: “We have granted
...
Muḥammad, was in reality for all the people. This mode of address, as
before said, was used by the perfect wisdom of God, so that the hearts of
the people might not be troubled, anxious and tormented.
...
confess their sins and faults. For these Holy Souls are pure from every
sin and sanctified from faults. In the Gospel it is said that a man came
to Christ and called Him “Good Master.” Christ answered, “Why callest thou
Me good? there is none good but One, that is, God.”(135) This did not
mean—God forbid!—that Christ was a sinner; but the intention was to teach
submission, humility, meekness and modesty to the man to whom He spoke.
These Holy Beings are lights, and light does not unite itself with
darkness. They are life, and life and death are not confounded. They are
for guidance, and guidance and error cannot be together. They are the
essence of obedience, and obedience cannot exist with rebellion.
...
It is said in the holy verse: “There is no partner for Him Who is the
Dayspring of Revelation(136) in His Most Great Infallibility. He is, in
truth, the exponent of ‘God doeth whatsoever He willeth’ in the kingdom of
creation. Indeed the Almighty hath exclusively reserved this station for
Himself and to none is given a share in this sublime and highly exalted
distinction.”(137)
...
of God and is inseparable from Him. Power is an essential necessity of God
and is inseparable from Him. If it could be separated from Him, He would
...
of God, and whatever They perform is an upright action. No believer has
...
existence would have been imperfect—that is to say, there would have been
...
law; therefore, they may be compared to one another. Thus the embryo of
man in the womb of the mother gradually grows and develops, and appears in
...
of the earth. The Pole Star at Akká, for instance, is at 33—that is to
...
species. No, as before mentioned, it is merely like the change and
...
creature—that is to say, between the Independent, the Most High, and the
other beings?

Answer.—The connection between God and the creatures is that of the
creator to the creation; it is like the connection between the sun and the
dark bodies of contingent beings, and is the connection between the maker
and the things that he has made. The sun in its own essence is independent
of the bodies which it lights, for its light is in itself and is free and
independent of the terrestrial globe; so the earth is under the influence
of the sun and receives its light, whereas the sun and its rays are
entirely independent of the earth. But if there were no sun, the earth and
all earthly beings could not exist.

The dependence of the creatures upon God is a dependence of emanation—that
is to say, creatures emanate from God; they do not manifest Him.(143) The
relation is that of emanation and not that of manifestation. The light of
the sun emanates from the sun; it does not manifest it. The appearance
through emanation is like the appearance of the rays from the luminary of
the horizons of the world—that is to say, the holy essence of the Sun of
Truth is not divided and does not descend to the condition of the
creatures. In the same way, the globe of the sun does not become divided
and does not descend to the earth. No, the rays of the sun, which are its
...
impossible, for the implication would be that the Absolute Preexistent is
...
Answer.—It has been before explained that spirit is universally divided
...
Manifestations of Israel. The Blessed Beauty(148) is also a lineal
...
considered members of the family, like Canaan,(149) who is not reckoned as
...
institutions, discoveries and enterprises come from the exercised
...
first and the last”(151)—that is to say, there has never been and never
...
comprehend the Preexistent Reality? Knowing God, therefore, means the
...
can the waves mount so high? From a nonexisting garden, how can such
...
rapid transit, at the most he can travel only twenty farsakhs(156) an
hour; in sleep, in the twinkling of an eye, he traverses the East and
West. For the spirit travels in two different ways: without means, which
is spiritual traveling; and with means, which is material traveling: as
birds which fly, and those which are carried.
...
distance(157) because through the instrumentality of the body the power of
the spirit is thus determined; but with the inner sight and the mental eye
it sees America, and it can perceive that which is there, and discover the
...
prayers of Bahá’u’lláh forgiveness and remission of sins are asked for
...
to cease to progress is the same as to decline; but it never leaves its
own condition, in which it continues to develop. For example, the reality
of the spirit of Peter, however far it may progress, will not reach to the
condition of the Reality of Christ; it progresses only in its own
environment.
...
they have not committed any sin and are not soiled with the impurities of
the world of nature, they are the centers of the manifestation of bounty,
and the Eye of Compassion will be turned upon them.
...
You question about eternal life and the entrance into the Kingdom. The
outer expression used for the Kingdom is heaven; but this is a comparison
and similitude, not a reality or fact, for the Kingdom is not a material
place; it is sanctified from time and place. It is a spiritual world, a
divine world, and the center of the Sovereignty of God; it is freed from
...
taste or touch. The mind which is in man, the existence of which is
recognized—where is it in him? If you examine the body with the eye, the
ear or the other senses, you will not find it; nevertheless, it exists.
Therefore, the mind has no place, but it is connected with the brain. The
Kingdom is also like this. In the same way love has no place, but it is
connected with the heart; so the Kingdom has no place, but is connected
with man.

Entrance into the Kingdom is through the love of God, through detachment,
through holiness and chastity, through truthfulness, purity,
...
excellent—that is, it is eternal; but to those souls who are veiled from
God, although they have life, it is dark, and in comparison with the life
of believers it is nonexistence.

For example, the eye and the nail are living; but the life of the nail in
relation to the life of the eye is nonexistent. This stone and this man
both exist; but the stone in relation to the existence of man is
nonexistent; it has no being; for when man dies, and his body is destroyed
and annihilated, it becomes like stone and earth. Therefore, it is clear
that although the mineral exists, in relation to man it is nonexistent.

In the same way, the souls who are veiled from God, although they exist in
this world and in the world after death, are, in comparison with the holy
existence of the children of the Kingdom of God, nonexisting and separated
from God.
...
For example, the eye sees, and all the body is affected; the ear hears,
and all the members of the body are moved. Of this there is no doubt; and
the universe is like a living person. Moreover, the connection which
exists between the members of beings must necessarily have an effect and
impression, whether it be material or spiritual.

For those who deny spiritual influence upon material things we mention
this brief example: wonderful sounds and tones, melodies and charming
...
problems. If God wills, another day, at the beginning of dinner, we will
...
God. If he is not aided, he is not able to do either good or evil. But
...
The other sort of converse, presence and communications of spirits is but
...
foundation. But many things come to the mind of man which are like the
waves of the sea of imaginations; they have no fruit, and no result comes
from them. In the same way, man sees in the world of sleep a vision which
becomes exactly realized; at another time, he sees a dream which has
...
starchy foods, the sugar constituent diminishes, the equilibrium is
...
intellectual thing which has no outward existence. All man’s
characteristics and qualities form an intellectual existence and are not
sensible.
...
want of guidance; forgetfulness is the want of memory; stupidity is the
want of good sense. All these things have no real existence.

In the same way, the sensible realities are absolutely good, and evil is
due to their nonexistence—that is to say, blindness is the want of sight,
deafness is the want of hearing, poverty is the want of wealth, illness is
the want of health, death is the want of life, and weakness is the want of
strength.

Nevertheless a doubt occurs to the mind—that is, scorpions and serpents
are poisonous. Are they good or evil, for they are existing beings? Yes, a
scorpion is evil in relation to man; a serpent is evil in relation to man;
but in relation to themselves they are not evil, for their poison is their
weapon, and by their sting they defend themselves. But as the elements of
their poison do not agree with our elements—that is to say, as there is
antagonism between these different elements, therefore, this antagonism is
evil; but in reality as regards themselves they are good.

The epitome of this discourse is that it is possible that one thing in
relation to another may be evil, and at the same time within the limits of
its proper being it may not be evil. Then it is proved that there is no
evil in existence; all that God created He created good. This evil is
nothingness; so death is the absence of life. When man no longer receives
life, he dies. Darkness is the absence of light: when there is no light,
there is darkness. Light is an existing thing, but darkness is
...
Certainly for an intelligent man death is better than sin, and a cut
tongue is better than lying or calumny.

The other kind of torment is gross—such as penalties, imprisonment,
...
beneficence, nevertheless, God treats them with mercy and forgives them.
...
continuance of mankind depends upon justice and not upon forgiveness. So
...
forgive him. But if a person wishes to assault Siyyid Man_sh_adí,(162)
certainly I will prevent him. Although for the malefactor noninterference
is apparently a kindness, it would be an oppression to Man_sh_adí. If at
...
in reality, they are causing destruction of morals and perversion of
...
Therefore, laws and regulations should be established which would permit
...
income of the factory itself, to which they have a right, that they will
...
And as man in this way is not forced nor obliged by the government, but is
...
Essential preexistence is an existence which is not preceded by a cause,
...
and that of man! The one in relation to the other is nonexistence. In the
...
have been decomposed, and have descended from the vegetable world to the
...
Zaqqúm,(164) no matter how frequently it may come back, will not bring
forth sweet fruit, and the good tree, no matter how often it may return,
...
by the belief in reincarnation and transmigration. Believers in it
...
innumerable! Then we must reflect how limitless and infinite are the
...
in the Kitáb-i-Íqán. Refer to it, so that you may be informed of the truth
...
restricted to the Theosophists and the Súfís; on the contrary, some of the
...
of preexistences and to enchainment;(175) and preexistences end by
becoming innumerable. As the individualization and the specification of
beings in the knowledge of God were the Essence of Unity itself, and as
there was not any difference between them, there was but one veritable
Unity, and all the things known were diffused and included in the reality
of the one Essence—that is to say, that, according to the mode of
simplicity and of unity, they constitute the knowledge of God the Most
High, and the Essence of the Reality. When God manifested His glory, these
individualizations and these specifications of beings which had a virtual
existence—that is to say, which were a form of the Divine Knowledge—found
their existence substantiated in the external world; and this Real
Existence resolved Itself into infinite forms. Such is the foundation of
their argument.

The Theosophists and the Súfís are divided into two branches: one,
comprising the mass, who, simply in the spirit of imitation, believe
pantheism without comprehending the meaning of their renowned savants; for
the mass of the Súfís believe that the signification of Being is general
existence, taken substantively, which is comprehended by the reason and
the intelligence—that is to say, that man comprehends it. Instead of that,
this general existence is one of the accidents which penetrate the reality
of beings, and the qualities of beings are the essence. This accidental
existence, which is dependent on beings, is like other properties of
things which depend on them. It is an accident among accidents, and
certainly that which is the essence is superior to that which is the
accident. For the essence is the origin, and the accident is the
consequence; the essence is dependent on itself, and the accident is
dependent on something else—that is to say, it needs an essence upon which
to depend. In this case, God would be the consequence of the creature. He
would have need of it, and it would be independent of Him.

For example, each time that the isolated elements combine conformably to
the divine universal system, one being among beings comes into the world.
That is to say, that when certain elements combine, a vegetable existence
is produced; when others combine, it is an animal; again others combine,
and they produce different creatures. In this case, the existence of
things is the consequence of their reality: how could it be that this
existence, which is an accident among accidents, and necessitates another
essence upon which it depends, should be the Preexistent Essence, the
Author of all things?

But the initiated savants of the Theosophists and Súfís, who have studied
...
is the truth of this question according to the Theosophists and the Súfís.
...
Briefly, this is the principal argument of the Súfís; and if we wished to
mention all their proofs and explain their answers, it would take a very
long time. This is their decisive proof and their plain argument—at least,
of the savants of the Súfís and the Theosophists.
...
To recapitulate: the Súfís admit God and the creature, and say that God
...
the intrinsic value of things. But the affirmation of the Súfís requires
...
and the eternal bounty. If the love of God did not exist, the contingent
...
is dictated by covetousness. For example, a butcher rears a sheep and
...
FOOTNOTES
   ...
   10 Cf. Jurjí Zaydán’s Umayyads and Abbasids, trans. D. S. Margoliouth.
   ...
   15 The Báb is here designated by His title Ḥaḍrat-i-A‘lá, His Supreme
   ...
   16 Doctors of the religion of Islám.

   17 Jamál-i-Mubárak, the Blessed Beauty, the title which is here given
      to Bahá’u’lláh. He is also called Jamál-i-Qidám, the Preexistent, or
      Ancient Beauty. But we shall designate Him as Bahá’u’lláh, the title
      by which He is known in the West.

   18 Exiled first to Ba_gh_dád, then to Constantinople, then to
      Adrianople, He was imprisoned in Akká (Acre), “the Greatest Prison,”
      in 1868.

   19 The penetrating judgment of Bahá’u’lláh upon this occasion overcame
      the malignity of His enemies, who, it was certain, would never agree
      in choosing what miracle to ask for.

   20 ‘Iráq; as opposed to that district of Írán known then as
   ...
   23 One of Bahá’u’lláh’s works written after His declaration.

   24 Son of a French Consul in Syria with whom Bahá’u’lláh had friendly
      relations.

   25 Name given to the epistles of Bahá’u’lláh.

   26 Valí.

   27 Cf. p. 30, n. 1. In giving such importance to this example of the
      good sense of Bahá’u’lláh, ‘Abdu’l-Bahá means to emphasize the
      uselessness of miracles as a proof of the truth of the
      Manifestations of God. Cf. “Miracles,” p. 100.

   28 A cry used as a declaration of faith by the Bahá’ís, literally, “Oh
   ...
   35 The reference appears in verses 11 and 12.

   36 Varaqat-Ibn-Nawfal, _Kh_adíjah’s cousin.

   37 The year 1290 from the proclamation of the mission of Muḥammad was
      the year 1280 of the Hejira, or 1863–64 of our era. It was at this
      epoch (April 1863) that Bahá’u’lláh, on leaving Ba_gh_dád for
      Constantinople, declared to those who surrounded Him that He was the
      Manifestation announced by the Báb.

      It is this declaration which the Bahá’ís celebrate by the Feast of
      Ridván, this name being that of the garden at the entrance of the
      city, where Bahá’u’lláh stayed during twelve days, and where He made
      the declaration.

   38 Rev. 11:3.

   39 This sentence is the Persian translation of the Arabic text of the
   ...
   50 Another name for the Qur’án, signifying the Distinction.

   51 Cf. Rev. 11:10.

   52 Cf. Rev. 11:11.

   53 Ḥájí Mullá Muḥammad-Alíy-i-Barfúrú_sh_í, one of the chief disciples
      of the Báb and one of the nineteen Letters of the Living.

   54 Rev. 11:12.

   55 The Báb and Jináb-i-Quddús.
   ...
   63 i.e., His most complete manifestation.
   ...
   71 One of the works of Bahá’u’lláh, in which He expressly points to
      ‘Abdu’l-Bahá as being the One to Whom all must turn after His death.

   72 One of the works of Bahá’u’lláh, in which He expressly points to
      ‘Abdu’l-Bahá as being the One to Whom all must turn after His death.
   ...
   78 Extract from the letter to Náṣiri’d-Dín _Sh_áh.

   79 Cf. Qur’án 19:17.

   80 Qur’án 36:35.

   81 This conversation shows the uselessness of discussions upon such
      questions; the teachings of ‘Abdu’l-Bahá upon the birth of Christ
   ...
   85 i.e., of Christ, Whom the Muslims frequently designate by the title
      of Rúhu’lláh, the Spirit of God.

   86 Cf. John 6:51, 50.

   87 Matt. 26:26.

   88 Matt. 8:22; John 3:6.

   89 Cf. Matt. 13:14 and John 12:40–41.

   90 Cf. Matt. 24:29–30.

   91 Kitáb-i-Íqán, one of the first works of Bahá’u’lláh, written at
      Ba_gh_dád, before the declaration of His manifestation.

   92 John 3:13.

   93 In these conversations, as the reader will have already observed,
      ‘Abdu’l-Bahá desires rather to indicate the meaning of certain
      passages of the Scriptures than to quote the exact text.

   94 Masí_kh_—i.e., the monster. In Arabic there is a play upon the words
      Masíh, the Messiah, and masí_kh_, the monster.

   95 Cf. 1 Thess. 5:2; 2 Pet. 3:10.

   96 Cf. “Pantheism,” p. 290.

   97 The Divine Manifestation.

   98 John 17:5.

   99 i.e., the Reality of Christ.

  100 Abu’l-ba_sh_ar, i.e., the father of man, is one of the titles given
      by the Muslims to Adam.

  101 Cf. John 6:41, 50, 58.

  102 Cf. Gen. 2:16–17.

  103 Cf. Gen. 3:5.

  104 Cf. Gen. 3:11–15,22
  ...
  112 Cf. “The Causes of Differences in the Characters of Men,” p. 212.
  ...
  116 i.e., the individuality.

  117 Matt. 16:18.

  118 It is well known that Peter’s real name was Simon, but Christ called
      him Cephas, which corresponds to the Greek word petras, which means
      rock.

  119 Cf. Matt. 16:14–18.
...
***END OF THE PROJECT GUTENBERG EBOOK SOME ANSWERED QUESTIONS***
...
This file should be named 19289-0.txt or 19289-0.zip.

This and all associated files of various formats will be found in:


    http://www.gutenberg.org/dirs/1/9/2/8/19289/
...
***FINIS***
  ...
  properties: [
    {
      ...
      defaultValueFn: function() {
        var alphaMap = Object.create(this.DIACRITICS_MAP),
            azAZ = 'azAZ', a = azAZ.charCodeAt(0), z = azAZ.charCodeAt(1),
            A = azAZ.charCodeAt(2), Z = azAZ.charCodeAt(3);
        var i, c;

        Object_forEach(this.DIACRITICS_MAP, function(value, key) {
          alphaMap[key] = value.toLowerCase();
        });
        ...
        for ( i = A; i <= Z; ++i ) {
          alphaMap[String.fromCharCode(i)] = String.fromCharCode(i + 32);
        }

        alphaMap[' '] = alphaMap['\b'] = alphaMap['\f'] = alphaMap['\n'] =
            alphaMap['\r'] = alphaMap['\t'] = alphaMap['\v'] = this.TOK_END;
  ...
  methods: [
    {
      name: 'slowTokenize',
      todo: multiline(function() {/* When Javascript implements character
        indexing that doesn't unnecessary objects (that then need to be garbage
        collected), use this tokenizer instead. */}),
      code: function(s) {
        var ts = [], t = [], l = s.length, m = this.alphaMap, TE = this.TOK_END;
        var c;
        for ( var i = 0; i < l; ++i ) {
          c = m[s[i]];
          if ( c ) { t.push(c); continue; }
          if ( c === TE && t.length > 0 ) { ts.push(t.join('')); t = []; continue; }
        }
        if ( t.length > 0 ) ts.push(t.join(''));
        return ts;
      }
    },
    {
      name: 'installInDocument',
      todo: 'Find a way to ensure that tests do not install in production',
      code: function() {
        // Generate tests from here because we want access to requires and
        // constants.
        var UnitTest = this.X.lookup('UnitTest');
        this.model_.tests = [
          UnitTest.create({
            name: 'Performance',
            description: 'Test running on a large string.',
            code: multiline(function() {/*
              var t = X.lookup('foam.dao.index.SlowTokenizer').create();
              var txt = multiline(function () {/**/}) +
              this.model_.SAQ + '*/});' + multiline(function() {/*
                var doTest = function(numRuns, fnName) {
                  var times = new Array(numRuns), avg = 0;
                  var i, ts, preTime, postTime, time;
                  for ( var i = 0; i < numRuns; ++i ) {
                    preTime = GLOBAL.performance.now();
                    ts = t[fnName](txt);
                    postTime = GLOBAL.performance.now();
                    time = postTime - preTime;
                    times[i] = time;
                    avg = avg + (time / numRuns);
                  }
                  var min = Math.ceil(Math.min.apply(Math, times)),
                      max = Math.ceil(Math.max.apply(Math, times)),
                      s1 = ts.length,
                      s2 = 0;
                  ts.forEach(function(tok) { s2 += tok.length; });
                  console.log(fnName + " :: Av:" + Math.ceil(avg) +
                      ";Mn:" + min + ";Mx:" + max + ";S1:" + s1 +
                      ";S2:" + s2 + ". ");
                  return {
                    avg: avg,
                ...
                var resTokenize = doTest(50,"tokenize");
                var resSlowTokenize = doTest(50, "slowTokenize");
                this.assert(resTokenize.avg * 2 <= resSlowTokenize.avg,
                    "Expected slow tokenize to be at least twice as slow as fast " +
                    "tokenize. Fast time: " + resTokenize.avg + ". Slow time: " +
                    resSlowTokenize.avg + ".");
                this.assert(resTokenize.s1 === resSlowTokenize.s1, "Expected " +
                    "number of tokens to match. Fast: " + resTokenize.s1 +
                    ". Slow: " + resSlowTokenize.s1 + ".");
                this.assert(resTokenize.s2 === resSlowTokenize.s2, "Expected " +
                    "sum of token lengths to match. Fast: " + resTokenize.s2 +
                    ". Slow: " + resSlowTokenize.s2 + ".");
                var lim = Math.max(resTokenize.s1, resSlowTokenize.s1);
                var i;
                for ( var i = 0; i < lim; ++i ) {
                  this.assert(resTokenize.ts[i] === resSlowTokenize.ts[i],
                      "Token " + i + " should match. Fast: " +
                      resTokenize.ts[i] + ". Slow: " + resSlowTokenize.ts[i] +
                      ".");
                }
                // For debugging failed tests:
                // if ( resTokenize.s1 !== resSlowTokenize.s1 ) {
                //   var lim = Math.min(resTokenize.s1, resSlowTokenize.s1);
                //   var i;
                //   for ( i = 0; i < lim; ++i ) {
                //     if ( resTokenize.ts[i] !== resSlowTokenize.ts[i] ) {
                //       debugger;
                //       break;
                //     }
                //   }
